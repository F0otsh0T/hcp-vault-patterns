...
## BACKGROUND
This pattern utilizes Azure AD B2B Collaboration method via OIDC and Vault Auth to enable AuthN for guest access into an Azure Tenant Application.  In this case, the Application will be Vault itself.
