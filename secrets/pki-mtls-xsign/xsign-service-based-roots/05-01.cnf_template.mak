...
cnf_template: foundation #target ## PKI Intermediate Roles
	data/scripts/05-01.01.cnf_template_nginx_1svc.sh
	data/scripts/05-01.02.cnf_template_nginx_2svc.sh
	data/scripts/05-01.03.cnf_template_nginx_3svc.sh
	data/scripts/05-02.01.cnf_template_html.sh
	data/scripts/05-03.01.cnf_template_container.sh
