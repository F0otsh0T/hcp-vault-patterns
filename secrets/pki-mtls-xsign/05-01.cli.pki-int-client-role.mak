...
#
default: help
.PHONY: help all clean foundation pki-int-client-role 

################################################################################
# ALL
#
all: foundation pki-int-client-role  #target ## All Targets
...
# PKI INT ROLES
#
pki-int-client-role: foundation #target ## PKI Int Roles
	data/scripts/05-01.01.cli.pki-int-client-role.sh
