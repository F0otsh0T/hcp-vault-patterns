...
#
default: help
.PHONY: help all clean foundation pki-int-client-cert 

################################################################################
# ALL
#
all: foundation pki-int-client-cert  #target ## All Targets
...
#
pki-int-client-cert: foundation #target ## PKI Int Certificates
	data/scripts/06-01.01.cli.pki-int-client-cert.sh
