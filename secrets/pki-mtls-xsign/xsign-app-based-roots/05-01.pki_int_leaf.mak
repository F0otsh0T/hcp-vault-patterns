...
pki_int_leaf: foundation #target ## PKI Intermediate Roles
	data/scripts/05-01.pki_int_amf_leaf.sh
	data/scripts/05-01.pki_int_amf_n11_leaf.sh
	data/scripts/05-01.pki_int_amf_n15_leaf.sh
	data/scripts/05-02.pki_int_nef_leaf.sh
	data/scripts/05-02.pki_int_nef_n29_leaf.sh
	data/scripts/05-03.pki_int_pcf_leaf.sh
	data/scripts/05-04.pki_int_smf_leaf.sh
	data/scripts/05-04.pki_int_smf_n7_leaf.sh
