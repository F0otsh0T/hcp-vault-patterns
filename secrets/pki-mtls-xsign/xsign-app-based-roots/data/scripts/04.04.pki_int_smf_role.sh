...
vault read -format=json pki_int_smf/roles/client > workspace/tmp/smf/role-client.json
jq < workspace/tmp/smf/role-client.json

vault read -format=json pki_int_smf/roles/server > workspace/tmp/smf/role-server.json
jq < workspace/tmp/smf/role-server.json