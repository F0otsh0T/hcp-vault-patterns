...
#
default: help
.PHONY: help all clean foundation pki-int-server-cert 

################################################################################
# ALL
#
all: foundation pki-int-server-cert  #target ## All Targets
...
################################################################################
# PKI INT CERTIFICATES
#
pki-int-server-cert: foundation #target ## PKI Int Certificates
	data/scripts/06-02.01.cli.pki-int-server-cert.sh
